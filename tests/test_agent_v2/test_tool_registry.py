...
def test_registry_has_8_tools():
    # suggest_next_step was removed (dead: no callback receiver on any channel,
    # 0 calls in 14d prod). 2026-08 — web_search added (gated on TAVILY_API_KEY
    # at LLM-exposure time, but always present in REGISTRY for dispatch).
