...
this module's `SupabaseProvider` name so the monkeypatch seam
...
# Patch-seam re-export: search_service resolves SupabaseProvider via this
# module at call time, so this name must stay importable here.
from app.providers.database import SupabaseProvider  # noqa: F401
from app.services.search_service import embedding_to_pgvector as _embedding_to_pgvector
from app.services.search_service import search_service

__all__ = ["search_step", "_embedding_to_pgvector", "SupabaseProvider"]
