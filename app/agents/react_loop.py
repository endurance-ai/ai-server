...
_SYSTEM_PROMPT = (
    ...
    "G1 — a previous `search_products`/`refine_search` already returned candidates AND the user's "
    "CURRENT message adds NO new search signal (greeting, thanks, chit-chat) → your NEXT action is "
    "`respond` (cards auto-attached). Avoid redundant tool calls: do NOT repeat search with the "
    "same query.\n"
