...
_SYSTEM_PROMPT = (
    ...
    "If you ever need the user's colour, ALWAYS use `ask_user_clarification(axis='color')` "
    "(never ask 'what colour?' in free text) — the server shows personalized colour buttons.\n"
