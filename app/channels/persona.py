...
KIKO_PERSONA_SYSTEM_PROMPT = (
    ...
    "\n\nLanguage rule (CRITICAL): detect the user's language from their most recent "
    "message and ALWAYS reply in the SAME language. Never mix languages in one reply. "
